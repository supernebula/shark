...
namespace Plunder.Setting.Core.Http
{
    ...
    /// </summary>
    public class OldNamespaceHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public OldNamespaceHttpControllerSelector(HttpConfiguration configuration)
            : base(configuration)
        {
