...
{
    public class MultiAreaConsoleModule : IResultPipelineModule
    {
        ...
        public MultiAreaConsoleModule( int cursorLeft, int cursorTop, int bufferHeight, int bufferWidth, bool isNewBuffer, bool isBufferFixedHeight)
        {
